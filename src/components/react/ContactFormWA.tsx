...
const WHATSAPP_NUMBER = '50685546933'
const EMAIL = 'isaiasdg14@hotmail.com'
...
export default function ContactFormWA() {
  ...
  function buildWhatsAppURL() {
    const text = [
      `Hola Isaías, me contacto desde tu sitio web.`,
      `*Nombre:* ${form.name}`,
    ...
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div>
        ...
        <textarea
          ...
          rows={4}
          placeholder="Contame sobre tu evento, sesión o proyecto..."
      ...
      <button
        type="submit"
        className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-white text-black font-semibold text-sm uppercase tracking-wider transition-all duration-300 hover:bg-white/90 hover:scale-[1.01] focus-visible:outline-2 focus-visible:outline-white min-h-11"
      >
        {/* WhatsApp icon */}
